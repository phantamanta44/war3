...
public class L96ItemRenderer extends BoltActionItemRenderer {

	protected String boltPart;
	
	public L96ItemRenderer(ResourceLocation path, ResourceLocation texMap, String clipObj, String boltObj, String boltThing, double off) {
		super(path, texMap, clipObj, boltObj, off);
		boltPart = boltThing;
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		GL11.glRotated(bolt * 12, 0.0, 0.0, 1.0);
		GL11.glTranslated(0.0, -boltOffset, 0.0);
		GL11.glTranslated(0.0, 0.0, bolt / 3);
