...
import io.github.phantamanta44.war3.lib.LibResources;
...
public class FXSparkle extends EntityFX {
	...
	@Override
	public void func_180434_a(WorldRenderer tessellator, Entity ph, float f, float f1, float f2, float f3, float f4, float f5) {
		this.f = f;
		this.f1 = f1;
		this.f2 = f2;
		this.f3 = f3;
	...
	public void onUpdate() {
		...
		if (!noClip && !fake && getBoundingBox() != null)
			pushOutOfBlocks(posX, (getBoundingBox().minY + getBoundingBox().maxY) / 2.0D, posZ);
	...
	protected boolean pushOutOfBlocks(double par1, double par3, double par5) {
		...
		if (!worldObj.isAirBlock(pos)) {
			boolean var16 = !worldObj.isBlockNormalCube(pos.west(), false);
			boolean var17 = !worldObj.isBlockNormalCube(pos.east(), false);
			boolean var18 = !worldObj.isBlockNormalCube(pos.north(), false);
			boolean var19 = !worldObj.isBlockNormalCube(pos.south(), false);
			boolean var20 = !worldObj.isBlockNormalCube(pos.down(), false);
			boolean var21 = !worldObj.isBlockNormalCube(pos.up(), false);
			byte var22 = -1;
